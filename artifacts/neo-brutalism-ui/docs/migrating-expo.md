# Migrating Expo UI to Neo Brutalism UI

Read `artifacts/neo-brutalism-ui/docs/AGENTS.md` and
`artifacts/neo-brutalism-ui/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/neo-brutalism-ui/lib/native-theme` and
  `@workspace/neo-brutalism-ui/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/neo-brutalism-ui/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/neo-brutalism-ui` and retains only
