# Migrating web UI to Neo Brutalism UI

Read `artifacts/neo-brutalism-ui/docs/AGENTS.md` and
`artifacts/neo-brutalism-ui/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/neo-brutalism-ui/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/neo-brutalism-ui/lib/utils`
- `@/hooks/use-toast` → `@workspace/neo-brutalism-ui/hooks/use-toast`
