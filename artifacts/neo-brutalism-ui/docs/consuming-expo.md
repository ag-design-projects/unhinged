# Consuming Neo Brutalism UI in Expo apps

Read `artifacts/neo-brutalism-ui/docs/AGENTS.md` first. React Native does
...
`artifacts/neo-brutalism-ui/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/neo-brutalism-ui/tokens";
...
```tsx
import { nativeTheme } from "@workspace/neo-brutalism-ui/lib/native-theme";
import { useColors } from "@workspace/neo-brutalism-ui/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/neo-brutalism-ui/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/neo-brutalism-ui/components/native/badge";
import { Button } from "@workspace/neo-brutalism-ui/components/native/button";
import { Card } from "@workspace/neo-brutalism-ui/components/native/card";
```
...
Import and render
`@workspace/neo-brutalism-ui/components/native/button`, then run Expo
